...
import edu.miu.cs489.eshopper.exception.UserNotFoundException;
...
public class WebApiExceptionHandler {
    ...
    public Map<String, String> handlePublisherNotFoundException(UserNotFoundException publisherNotFoundException) {
